function getGlobal(){return function(){return this.dust}.call(null)}var dust={}
!function(dust){function Context(n,l,t,u){this.stack=n,this.global=l,this.blocks=t,this.templateName=u}function Stack(n,l,t,u){this.tail=l,this.isObject=!dust.isArray(n)&&n&&"object"==typeof n,this.head=n,this.index=t,this.of=u}function Stub(n){this.head=new Chunk(this),this.callback=n,this.out=""}function Stream(){this.head=new Chunk(this)}function Chunk(n,l,t){this.root=n,this.next=l,this.data=[],this.flushable=!1,this.taps=t}function Tap(n,l){this.head=n,this.tail=l}dust.helpers={},dust.cache={},dust.register=function(n,l){n&&(dust.cache[n]=l)},dust.render=function(n,l,t){var u=new Stub(t).head
dust.load(n,u,Context.wrap(l,n)).end()},dust.stream=function(n,l){var t=new Stream
return dust.nextTick(function(){dust.load(n,t.head,Context.wrap(l,n)).end()}),t},dust.renderSource=function(n,l,t){return dust.compileFn(n)(l,t)},dust.compileFn=function(n,l){var t=dust.loadSource(dust.compile(n,l))
return function(n,u){var e=u?new Stub(u):new Stream
return dust.nextTick(function(){t(e.head,Context.wrap(n,l)).end()}),e}},dust.load=function(n,l,t){var u=dust.cache[n]
...
"s"===r?l=null:"function"==typeof dust.filters[r]&&(n=dust.filters[r](n))}return l&&(n=dust.filters[l](n)),n},dust.filters={h:function(n){return dust.escapeHtml(n)},j:function(n){return dust.escapeJs(n)},u:encodeURI,uc:encodeURIComponent,js:function(n){return JSON?JSON.stringify(n):n},jp:function(n){return JSON?JSON.parse(n):n}},dust.makeBase=function(n){return new Context(new Stack,n)},Context.wrap=function(n,l){return n instanceof Context?n:new Context(new Stack(n),{},null,l)},Context.prototype.get=function(n){for(var l,t=this.stack;t;){if(t.isObject&&(l=t.head[n],void 0!==l))return l
t=t.tail}return this.global?this.global[n]:void 0},Context.prototype.getPath=function(n,l){var t,u=this.stack,e=l.length,r=n?void 0:this.stack.tail
if(n&&0===e)return u.head
u=u.head
for(var o=0;u&&e>o;)for(t=u,u=u[l[o]],o++;!u&&!n;){if(o>1)return u
r?(u=r.head,r=r.tail,o=0):n||(u=this.global,n=!0,o=0)}return"function"==typeof u?function(){return u.apply(t,arguments)}:u},Context.prototype.push=function(n,l,t){return new Context(new Stack(n,this.stack,l,t),this.global,this.blocks,this.templateName)},Context.prototype.rebase=function(n){return new Context(new Stack(n),this.global,this.blocks,this.templateName)},Context.prototype.current=function(){return this.stack.head},Context.prototype.getBlock=function(n){if("function"==typeof n){var l=new Chunk
n=n(l,this).data.join("")}var t=this.blocks
if(t)for(var u,e=t.length;e--;)if(u=t[e][n])return u},Context.prototype.shiftBlocks=function(n){var l,t=this.blocks
return n?(l=t?t.concat([n]):[n],new Context(this.stack,this.global,l,this.templateName)):this},Stub.prototype.flush=function(){for(var n=this.head;n;){if(!n.flushable)return n.error?(this.callback(n.error),this.flush=function(){},void 0):void 0
this.out+=n.data.join(""),n=n.next,this.head=n}this.callback(null,this.out)},Stream.prototype.flush=function(){for(var n=this.head;n;){if(!n.flushable)return n.error?(this.emit("error",n.error),this.flush=function(){},void 0):void 0
this.emit("data",n.data.join("")),n=n.next,this.head=n}this.emit("end")},Stream.prototype.emit=function(n,l){if(!this.events)return!1
var t=this.events[n]
if(!t)return!1
...
return l&&(n=l.go(n)),this.data.push(n),this},Chunk.prototype.end=function(n){return n&&this.write(n),this.flushable=!0,this.root.flush(),this},Chunk.prototype.map=function(n){var l=new Chunk(this.root,this.next,this.taps),t=new Chunk(this.root,l,this.taps)
...
u=dust.makeBase(l.global),u.blocks=l.blocks,l.stack&&l.stack.tail&&(u.stack=l.stack.tail),t&&(u=u.push(t)),"string"==typeof n&&(u.templateName=n),u=u.push(l.stack.head)
var e
return e="function"==typeof n?this.capture(n,u,function(n,l){dust.load(n,l,u).end()}):dust.load(n,this,u)},Chunk.prototype.helper=function(n,l,t,u){return dust.helpers[n]?dust.helpers[n](this,l,t,u):this},Chunk.prototype.capture=function(n,l,t){return this.map(function(u){var e=new Stub(function(n,l){n?u.setError(n):t(l,u)})
...
dust.escapeJs=function(n){return"string"==typeof n?n.replace(BS,"\\\\").replace(FS,"\\/").replace(DQ,'\\"').replace(SQ,"\\'").replace(CR,"\\r").replace(LS,"\\u2028").replace(PS,"\\u2029").replace(NL,"\\n").replace(LF,"\\f").replace(TB,"\\t"):n}}(dust),"undefined"!=typeof exports&&("undefined"!=typeof process&&require("./server")(dust),module.exports=dust)
...
f&&("buffer"===f[0]?u?u[1]+=f[1]:(u=f,e.push(f)):(u=null,e.push(f)))}return e}function e(n,l){return["buffer",h[l[1]]]}function r(n,l){return l}function o(){}function f(l,t){var u={name:t,bodies:[],blocks:{},index:0,auto:"h"}
...
return u}function a(l,t,u){return"."+u+"("+n.compileNode(l,t[1])+","+n.compileNode(l,t[2])+","+n.compileNode(l,t[4])+","+n.compileNode(l,t[3])+")"}n.compile=function(t,u){try{var e=l(n.parse(t))
return f(e,u)}catch(r){if(!r.line||!r.column)throw r
throw new SyntaxError(r.message+" At line : "+r.line+", column : "+r.column)}},n.filterNode=function(l,t){return n.optimizers[t[0]](l,t)},n.optimizers={body:u,buffer:r,special:e,format:o,reference:t,"#":t,"?":t,"^":t,"<":t,"+":t,"@":t,"%":t,partial:t,context:t,params:t,bodies:t,param:t,filters:r,key:r,path:r,literal:r,comment:o,line:o,col:o},n.pragmas={esc:function(n,l,t){var u=n.auto
l||(l="h"),n.auto="s"===l?"":l
var e=c(n,t.block)
return n.auto=u,e}}
var h={s:" ",n:"\n",r:"\r",lb:"{",rb:"}"}
...
if("block"===f)return l.blocks[t[1].text]=n.compileNode(l,o[2]),""}return""},"+":function(l,t){return void 0===t[1].text&&void 0===t[4]?".block(ctx.getBlock("+n.compileNode(l,t[1])+",chk, ctx),"+n.compileNode(l,t[2])+", {},"+n.compileNode(l,t[3])+")":".block(ctx.getBlock("+p(t[1].text)+"),"+n.compileNode(l,t[2])+","+n.compileNode(l,t[4])+","+n.compileNode(l,t[3])+")"},"@":function(l,t){return".helper("+p(t[1].text)+","+n.compileNode(l,t[2])+","+n.compileNode(l,t[4])+","+n.compileNode(l,t[3])+")"},"%":function(l,t){var u=t[1][1]
...
return null!==n&&(n=function(n,l,t,u){return["body"].concat(u).concat([["line",l],["col",t]])}(t.offset,t.line,t.column,n)),null===n&&(U=e(t)),n}function i(){var n
return n=B(),null===n&&(n=s(),null===n&&(n=v(),null===n&&(n=g(),null===n&&(n=m(),null===n&&(n=T()))))),n}function s(){var n,l,u,i,s,h,p,m,v
...
if(null!==n&&(n=function(n,l,t,u,e,r){return r.push(["param",["literal","block"],e]),u.push(r),u.concat([["line",l],["col",t]])}(m.offset,m.line,m.column,n[0],n[3],n[4],n[5])),null===n&&(U=e(m)),null===n){if(m=e(U),v=e(U),n=c(),null!==n){for(l=[],u=Q();null!==u;)l.push(u),u=Q()
null!==l?(47===t.charCodeAt(U.offset)?(u="/",r(U,1)):(u=null,0===Z&&o('"/"')),null!==u?(i=L(),null!==i?n=[n,l,u,i]:(n=null,U=e(v))):(n=null,U=e(v))):(n=null,U=e(v))}else n=null,U=e(v)
null!==n&&(n=function(n,l,t,u){return u.push(["bodies"]),u.concat([["line",l],["col",t]])}(m.offset,m.line,m.column,n[0])),null===n&&(U=e(m))}return Z--,0===Z&&null===n&&o("section"),n}function c(){var n,l,u,f,i,s,c,a
...
null!==u?(f=y(),null!==f?(i=h(),null!==i?(s=p(),null!==s?n=[n,l,u,f,i,s]:(n=null,U=e(a))):(n=null,U=e(a))):(n=null,U=e(a))):(n=null,U=e(a))}else n=null,U=e(a)
else n=null,U=e(a)
...
if(Z++,c=e(U),a=e(U),n=R(),null!==n)if(47===t.charCodeAt(U.offset)?(l="/",r(U,1)):(l=null,0===Z&&o('"/"')),null!==l){for(u=[],f=Q();null!==f;)u.push(f),f=Q()
if(null!==u)if(f=y(),null!==f){for(i=[],s=Q();null!==s;)i.push(s),s=Q()
...
return Z++,r=e(U),f=e(U),n=R(),null!==n?(l=y(),null!==l?(t=b(),null!==t?(u=L(),null!==u?n=[n,l,t,u]:(n=null,U=e(f))):(n=null,U=e(f))):(n=null,U=e(f))):(n=null,U=e(f)),null!==n&&(n=function(n,l,t,u,e){return["reference",u,e].concat([["line",l],["col",t]])}(r.offset,r.line,r.column,n[1],n[2])),null===n&&(U=e(r)),Z--,0===Z&&null===n&&o("reference"),n}function v(){var n,l,u,f,i,s,c,a,d,m,v,b
if(Z++,m=e(U),v=e(U),n=R(),null!==n)if(62===t.charCodeAt(U.offset)?(l=">",r(U,1)):(l=null,0===Z&&o('">"')),null===l&&(43===t.charCodeAt(U.offset)?(l="+",r(U,1)):(l=null,0===Z&&o('"+"'))),null!==l){for(u=[],f=Q();null!==f;)u.push(f),f=Q()
...
null!==c?(47===t.charCodeAt(U.offset)?(a="/",r(U,1)):(a=null,0===Z&&o('"/"')),null!==a?(d=L(),null!==d?n=[n,l,u,f,i,s,c,a,d]:(n=null,U=e(v))):(n=null,U=e(v))):(n=null,U=e(v))}else n=null,U=e(v)
else n=null,U=e(v)
else n=null,U=e(v)
else n=null,U=e(v)}else n=null,U=e(v)
else n=null,U=e(v)
return null!==n&&(n=function(n,l,t,u,e,r,o){var f=">"===u?"partial":u
return[f,e,r,o].concat([["line",l],["col",t]])}(m.offset,m.line,m.column,n[1],n[3],n[4],n[5])),null===n&&(U=e(m)),Z--,0===Z&&null===n&&o("partial"),n}function b(){var n,l,u,f,i,s
for(Z++,f=e(U),n=[],i=e(U),s=e(U),124===t.charCodeAt(U.offset)?(l="|",r(U,1)):(l=null,0===Z&&o('"|"')),null!==l?(u=S(),null!==u?l=[l,u]:(l=null,U=e(s))):(l=null,U=e(s)),null!==l&&(l=function(n,l,t,u){return u}(i.offset,i.line,i.column,l[1])),null===l&&(U=e(i));null!==l;)n.push(l),i=e(U),s=e(U),124===t.charCodeAt(U.offset)?(l="|",r(U,1)):(l=null,0===Z&&o('"|"')),null!==l?(u=S(),null!==u?l=[l,u]:(l=null,U=e(s))):(l=null,U=e(s)),null!==l&&(l=function(n,l,t,u){return u}(i.offset,i.line,i.column,l[1])),null===l&&(U=e(i))
return null!==n&&(n=function(n,l,t,u){return["filters"].concat(u)}(f.offset,f.line,f.column,n)),null===n&&(U=e(f)),Z--,0===Z&&null===n&&o("filters"),n}function g(){var n,l,u,f,i,s
return Z++,i=e(U),s=e(U),n=R(),null!==n?(126===t.charCodeAt(U.offset)?(l="~",r(U,1)):(l=null,0===Z&&o('"~"')),null!==l?(u=S(),null!==u?(f=L(),null!==f?n=[n,l,u,f]:(n=null,U=e(s))):(n=null,U=e(s))):(n=null,U=e(s))):(n=null,U=e(s)),null!==n&&(n=function(n,l,t,u){return["special",u].concat([["line",l],["col",t]])}(i.offset,i.line,i.column,n[2])),null===n&&(U=e(i)),Z--,0===Z&&null===n&&o("special"),n}function y(){var n,l
...
if(Z++,i=e(U),s=e(U),n=A(),null!==n)if(46===t.charCodeAt(U.offset)?(l=".",r(U,1)):(l=null,0===Z&&o('"."')),null!==l){if(f=A(),null!==f)for(u=[];null!==f;)u.push(f),f=A()
else u=null
null!==u?n=[n,l,u]:(n=null,U=e(s))}else n=null,U=e(s)
else n=null,U=e(s)
return null!==n&&(n=function(n,l,t,u,e){return parseFloat(u+"."+e.join(""))}(i.offset,i.line,i.column,n[0],n[2])),null===n&&(U=e(i)),Z--,0===Z&&null===n&&o("float"),n}function A(){var n,l,u
...
if(null!==n&&(n=function(n,l,t,u,e){return e=e[0],u&&e?(e.unshift(u),[!1,e].concat([["line",l],["col",t]])):[!0,e].concat([["line",l],["col",t]])}(f.offset,f.line,f.column,n[0],n[1])),null===n&&(U=e(f)),null===n){if(f=e(U),i=e(U),46===t.charCodeAt(U.offset)?(n=".",r(U,1)):(n=null,0===Z&&o('"."')),null!==n){for(l=[],u=w(),null===u&&(u=N());null!==u;)l.push(u),u=w(),null===u&&(u=N())
null!==l?n=[n,l]:(n=null,U=e(i))}else n=null,U=e(i)
null!==n&&(n=function(n,l,t,u){return u.length>0?[!0,u[0]].concat([["line",l],["col",t]]):[!0,[]].concat([["line",l],["col",t]])}(f.offset,f.line,f.column,n[1])),null===n&&(U=e(f))}return Z--,0===Z&&null===n&&o("path"),n}function S(){var n,l,u,f,i
...
null!==l&&(l=function(n,l,t,u){return u.join("")}(a.offset,a.line,a.column,l)),null===l&&(U=e(a)),null===l&&(l=y()),null!==l?(u=J(),null!==u?n=[n,l,u]:(n=null,U=e(c))):(n=null,U=e(c))}else n=null,U=e(c)
...
if(Z++,f=e(U),i=e(U),34===t.charCodeAt(U.offset)?(n='"',r(U,1)):(n=null,0===Z&&o('"\\""')),null!==n?(34===t.charCodeAt(U.offset)?(l='"',r(U,1)):(l=null,0===Z&&o('"\\""')),null!==l?n=[n,l]:(n=null,U=e(i))):(n=null,U=e(i)),null!==n&&(n=function(n,l,t){return["literal",""].concat([["line",l],["col",t]])}(f.offset,f.line,f.column)),null===n&&(U=e(f)),null===n&&(f=e(U),i=e(U),34===t.charCodeAt(U.offset)?(n='"',r(U,1)):(n=null,0===Z&&o('"\\""')),null!==n?(l=F(),null!==l?(34===t.charCodeAt(U.offset)?(u='"',r(U,1)):(u=null,0===Z&&o('"\\""')),null!==u?n=[n,l,u]:(n=null,U=e(i))):(n=null,U=e(i))):(n=null,U=e(i)),null!==n&&(n=function(n,l,t,u){return["literal",u].concat([["line",l],["col",t]])}(f.offset,f.line,f.column,n[1])),null===n&&(U=e(f)),null===n)){if(f=e(U),i=e(U),34===t.charCodeAt(U.offset)?(n='"',r(U,1)):(n=null,0===Z&&o('"\\""')),null!==n){if(u=E(),null!==u)for(l=[];null!==u;)l.push(u),u=E()
else l=null
null!==l?(34===t.charCodeAt(U.offset)?(u='"',r(U,1)):(u=null,0===Z&&o('"\\""')),null!==u?n=[n,l,u]:(n=null,U=e(i))):(n=null,U=e(i))}else n=null,U=e(i)
null!==n&&(n=function(n,l,t,u){return["body"].concat(u).concat([["line",l],["col",t]])}(f.offset,f.line,f.column,n[1])),null===n&&(U=e(f))}return Z--,0===Z&&null===n&&o("inline"),n}function E(){var n,l
return n=g(),null===n&&(n=m(),null===n&&(l=e(U),n=F(),null!==n&&(n=function(n,l,t,u){return["buffer",u]}(l.offset,l.line,l.column,n)),null===n&&(U=e(l)))),n}function T(){var n,l,u,f,i,s,c,a,h
if(Z++,s=e(U),c=e(U),n=z(),null!==n){for(l=[],u=Q();null!==u;)l.push(u),u=Q()
null!==l?n=[n,l]:(n=null,U=e(c))}else n=null,U=e(c)
if(null!==n&&(n=function(n,l,t,u,e){return["format",u,e.join("")].concat([["line",l],["col",t]])}(s.offset,s.line,s.column,n[0],n[1])),null===n&&(U=e(s)),null===n){if(s=e(U),c=e(U),a=e(U),h=e(U),Z++,l=O(),Z--,null===l?l="":(l=null,U=e(h)),null!==l?(h=e(U),Z++,u=B(),Z--,null===u?u="":(u=null,U=e(h)),null!==u?(h=e(U),Z++,f=z(),Z--,null===f?f="":(f=null,U=e(h)),null!==f?(t.length>U.offset?(i=t.charAt(U.offset),r(U,1)):(i=null,0===Z&&o("any character")),null!==i?l=[l,u,f,i]:(l=null,U=e(a))):(l=null,U=e(a))):(l=null,U=e(a))):(l=null,U=e(a)),null!==l&&(l=function(n,l,t,u){return u}(c.offset,c.line,c.column,l[3])),null===l&&(U=e(c)),null!==l)for(n=[];null!==l;)n.push(l),c=e(U),a=e(U),h=e(U),Z++,l=O(),Z--,null===l?l="":(l=null,U=e(h)),null!==l?(h=e(U),Z++,u=B(),Z--,null===u?u="":(u=null,U=e(h)),null!==u?(h=e(U),Z++,f=z(),Z--,null===f?f="":(f=null,U=e(h)),null!==f?(t.length>U.offset?(i=t.charAt(U.offset),r(U,1)):(i=null,0===Z&&o("any character")),null!==i?l=[l,u,f,i]:(l=null,U=e(a))):(l=null,U=e(a))):(l=null,U=e(a))):(l=null,U=e(a)),null!==l&&(l=function(n,l,t,u){return u}(c.offset,c.line,c.column,l[3])),null===l&&(U=e(c))
else n=null
null!==n&&(n=function(n,l,t,u){return["buffer",u.join("")].concat([["line",l],["col",t]])}(s.offset,s.line,s.column,n)),null===n&&(U=e(s))}return Z--,0===Z&&null===n&&o("buffer"),n}function F(){var n,l,u,f,i,s,c
...
return null!==n&&(n=function(n,l,t,u){return["comment",u.join("")].concat([["line",l],["col",t]])}(i.offset,i.line,i.column,n[1])),null===n&&(U=e(i)),Z--,0===Z&&null===n&&o("comment"),n}function O(){var n,l,u,f,i,s,c,a,h,p,d
...
return 123===t.charCodeAt(U.offset)?(n="{",r(U,1)):(n=null,0===Z&&o('"{"')),n}function L(){var n
return 125===t.charCodeAt(U.offset)?(n="}",r(U,1)):(n=null,0===Z&&o('"}"')),n}function $(){var n
return 91===t.charCodeAt(U.offset)?(n="[",r(U,1)):(n=null,0===Z&&o('"["')),n}function J(){var n
return 93===t.charCodeAt(U.offset)?(n="]",r(U,1)):(n=null,0===Z&&o('"]"')),n}function z(){var n
return 10===t.charCodeAt(U.offset)?(n="\n",r(U,1)):(n=null,0===Z&&o('"\\n"')),null===n&&("\r\n"===t.substr(U.offset,2)?(n="\r\n",r(U,2)):(n=null,0===Z&&o('"\\r\\n"')),null===n&&(13===t.charCodeAt(U.offset)?(n="\r",r(U,1)):(n=null,0===Z&&o('"\\r"')),null===n&&(8232===t.charCodeAt(U.offset)?(n="\u2028",r(U,1)):(n=null,0===Z&&o('"\\u2028"')),null===n&&(8233===t.charCodeAt(U.offset)?(n="\u2029",r(U,1)):(n=null,0===Z&&o('"\\u2029"')))))),n}function Q(){var n
...
return t}var P={body:f,part:i,section:s,sec_tag_start:c,end_tag:a,context:h,params:p,bodies:d,reference:m,partial:v,filters:b,special:g,identifier:y,number:k,"float":x,integer:A,path:C,key:S,array:N,array_part:w,inline:j,inline_part:E,buffer:T,literal:F,esc:_,comment:B,tag:O,ld:R,rd:L,lb:$,rb:J,eol:z,ws:Q}
if(void 0!==u){if(void 0===P[u])throw Error("Invalid rule name: "+n(u)+".")}else u="body"
